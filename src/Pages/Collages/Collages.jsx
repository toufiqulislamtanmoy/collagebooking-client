...
const Collages = () => {
    ...
    return (
        <div>
            <SectionTitle title="All Reputed Collage" />
            ...
            <div className="max-w-7xl my-7 mx-5 lg:mx-auto gap-5 grid grid-cols-1 md:grid-cols-3">
                {
                    collages.map(collage =>
                        ...
                        <div key={collage._id} className="card bg-base-100 shadow-xl">
                            <figure><img src={collage.collegeImage} alt={collage.collegeName} /></figure>
                            <div className="card-body">
                                ...
                                <p><span className="font-semibold">Total Research works: </span>{collage.researchWorks.length}</p>
                            
                                <div className="card-actions my-3">
                                    <Link to={`/collegeDetails/${collage._id}`} className="btn btn-primary w-full">See Details</Link>
                                </div>
                            </div>
                        </div>
